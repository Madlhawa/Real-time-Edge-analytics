...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("madhawa/past/startEndDate")
...
def on_message(client, userdata, msg):
    ...
    for index, row in output.iterrows():
        ...
        publish.single("madhawa/past/data", row['Avg_Temp'], hostname=server)
...
temp1 = pd.read_csv('/home/pi/LABS/Asingment/Real-time-Edge-analytics/TempData1.csv', skiprows=0)
